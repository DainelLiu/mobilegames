...
public class CommentAction {
	...
	public String delete() throws IOException{
		...
		String commId = ServletActionContext.getRequest().getParameter("commId");
		Comment comment = commentDao.getById(commId);
		JSONObject jobj = new JSONObject();
	...
	public String listAll() throws IOException{
		...
		if(commentTypelist.size() > 0){
			...
			jobj.put("mes", "获取成功!");
			jobj.put("status", "success");
			jobj.put("data", JsonUtil.toJsonByListObj(commentTypelist));
		}else{
			//save failed
			jobj.put("mes", "获取失败!");
			jobj.put("status", "error");
